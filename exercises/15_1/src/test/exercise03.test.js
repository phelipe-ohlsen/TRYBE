...
describe('Testando funcionalidade de apagar item selecionado', () => {
  it('Necessário ter um botão, com o texto Remover, e ele precisa estar desabilitado caso não exista nenhum item selecionado', () => {
  ...
  it('Testando a seleção de elemento', () => {
